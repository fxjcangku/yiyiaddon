...
// 侧栏版本号取自 gradle.properties，避免版本升级后预览还停在上一个测试版。
const modVersion = /^mod_version=(.+)$/m.exec(fs.readFileSync(root + '/../gradle.properties', 'utf8'))[1].trim();
...
<div class="layout"><aside><div class="eyebrow">功能栏</div><nav>${toc}</nav><div class="note">Minecraft 26.x<br>Beta 公开测试版<br><br>图形为功能概念示意<br>实际界面以游戏为准</div></aside><main><div class="filebar"><span id="filename">README.md</span><span>${modVersion} · 公开测试版</span></div><article class="markdown" id="home">${home}</article><article class="markdown" id="release" hidden>${release}</article><div class="foot">正文来自发布草稿 · GitHub 实际排版以平台渲染为准</div></main></div>
<script>
