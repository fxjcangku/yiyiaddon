...
public final class EspSettingsPage extends BasePage {
    ...
    private static final HelpPanelScreen.HelpSection[] HELP_SECTIONS = {
        ...
        new HelpPanelScreen.HelpSection("外观：怎么画",
            ...
            "  §7     并且有一条亮带沿路径朝目标流动（流光，约 11 格/秒，带处略粗一档）—— 方向一眼可见",
            "  §7     规划段偏冷灰蓝并压暗，计算中的路径再暗一档；非矿石目标框与选区主体同色",
            "  §a▸ §f目标框 §8- §7整框上下浮动；目标是矿石时按种类上色（煤灰 / 铜橙 / 铁米白 / 金黄金 /",
            "  §7     红石红 / 青金蓝 / 钻青 / 翠绿 / 石英白 / 残骸褐），一片混合矿区一眼分得清",
            "  §a▸ §f挖掘框 §8- §7待破坏 / 待放置 / 待进入三色（暖 / 冷 / 青绿）；矿石那一格用它的矿石色，",
            "  §7     线略微抬离方块面不闪"
        ),
