 ...
 *
 * <p><b>用户交互资产</b>：模块名 {@code 水源显示}、描述
 * {@code 标记 9×9 灌溉范围与可放水点}（原为旧 {@code WaterESPModule :78-79} 的「已放水渲染蓝色 9×9
 * 灌溉范围，在已有水源旁显示红色建议框提示可放水位置。」，2026-09-21 按「一行放得下的中文短注」重写，
 * 见 166 号复盘第十一节）；10 个设置项名称 / 描述 / 默认值逐字
 * （51 号第五节全表）。</p>
 *
