...
public final class AutoLoginTexts {
    ...
    /** 模块说明（模块页标题下与控制台标题下同一份；逐字 = 旧项目构造器实参） */
    public static final String DESCRIPTION =
        "自动注册、登录、断线重连、进服后执行指令序列。详细参考下面使用说明。";
