...
> 233 及以后开发**先读本文件**；需要过程证据时再查历史报告：
> `seedmining-phase4-232-report.md`（232 · 技术闭环过程）、
> `seedmining-phase4p-232p-report.md`（232-P · 生产发行过程）、
...
| `seedmining-phase4-232-report.md` | 232 历史过程（含 231 遗留处理、IPC/生命周期设计与 §102 六十七项对照） |
| `seedmining-phase4p-232p-report.md` | 232-P 历史过程（含 14 次冒烟逐次记录、附录 A 文件清单与附录 B 证据索引） |
